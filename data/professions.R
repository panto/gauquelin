...
# Get raw data
vol1  <- read.delim("data/series-A-professions/Gauquelin-vol1-Sportsmans.tsv")
vol2  <- read.delim("data/series-A-professions/Gauquelin-vol2-Scientists-Doctors.tsv")
vol3  <- read.delim("data/series-A-professions/Gauquelin-vol3-Military.tsv")
vol4  <- read.delim("data/series-A-professions/Gauquelin-vol4-Painters-Musicans.tsv")
vol5  <- read.delim("data/series-A-professions/Gauquelin-vol5-Actors-Politicans.tsv")
vol6  <- read.delim("data/series-A-professions/Gauquelin-vol6-Writers-Jurnalists.tsv")
